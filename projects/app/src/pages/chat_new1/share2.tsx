...
import { getChatHistory, getInitChatSiteInfo } from '@/web/core/chat/api';
...
const OutLink = ({
  ...
  useEffect(() => {
    ...
    console.log('');
    ChatBoxRef.current?.getChatHistory();
  }, []);

  const getHistoryByChatId = (chatId: string) => {};
          ...
          ? ((children: React.ReactNode) => {
              ...
              <ChatHistorySlider
                ...
                onChangeChat={(chatId) => {
                  ...
                  getHistoryByChatId(chatId as string);
                  if (!isPc) {
                    onCloseSlider();
                  }
                }}
