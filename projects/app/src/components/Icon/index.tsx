...
const iconPaths = {
  ...
  delete1: () => import('./icons/delete1.svg'),
  ...
  chat1: () => import('./icons/light/chat1.svg'),
  chat2: () => import('./icons/light/chat2.svg'),
  chat3: () => import('./icons/light/chat3.svg'),
  chat4: () => import('./icons/light/chat4.svg'),
  chat5: () => import('./icons/light/chat5.svg'),
  chat6: () => import('./icons/light/chat6.svg'),
  chat7: () => import('./icons/light/chat7.svg'),
  chat8: () => import('./icons/light/chat8.svg'),
  top: () => import('./icons/light/top.svg'),
  ...
  copy_blue: () => import('./icons/copy_blue.svg')
};
